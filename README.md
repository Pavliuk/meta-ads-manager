...
```
📣 Керування рекламою
[📋 Кампанії]  [➕ Нова кампанія]
```

- **📋 Кампанії** → список (🟢 активна / ⏸️ на паузі) → тап на кампанію → картка
  зі статусом, ціллю і бюджетом, кнопки **⏸️ Пауза / ▶️ Запустити**, **🎯 Ad sets**,
  **📊 Аналітика**, **✏️ Редагувати** (назва/бюджет), **🗑 Видалити** (з підтвердженням)
...
- **🎯 Ad sets** (з картки кампанії) → список ad set'ів → тап → пауза/запуск,
  **📋 Оголошення** (список), **➕ Нове оголошення**, **✏️ Редагувати**,
  **🗑 Видалити**; **➕ Новий ad set** запитує назву → бюджет → країни →
  мінімальний вік → максимальний вік → стать (кнопками) → платформи
  FB/IG/обидві (кнопками)
- **📋 Оголошення** (з картки ad set'а) → список оголошень → тап → картка зі
  статусом, кнопки **⏸️ Пауза / ▶️ Запустити**, **🗑 Видалити**
- **➕ Нове оголошення** → запитує посилання → текст → заголовок → фото (можна
  ...
  статусом PAUSED
- **📊 Аналітика** (з картки кампанії) → кнопки періоду (сьогодні/7/30/90 днів) →
  таблиця витрат/показів/кліків
